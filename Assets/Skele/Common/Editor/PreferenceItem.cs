...
namespace MH.Skele
{
    public class Pref
    {
        ...
        private static bool m_showIKDebug;
        public static bool showIKDebug
        {
            get { return m_showIKDebug; }
            set { m_showIKDebug = value; }
        }
        ...
        public const string Pref_ShowIKDebug = "MH.Skele.ShowIKDebug";
        ...
        private static void _LoadPrefs()
        {
            ...
            m_showIKDebug                   = LoadPrefBool(Pref_ShowIKDebug, true);
        ...
        private static void _SavePrefs()
        {
            ...
            SavePrefBool(Pref_ShowIKDebug, m_showIKDebug);
        }
        ...
        private static void _GUI_CAT()
        {
            ...
            m_showIKDebug = EditorGUILayout.Toggle("Show IK debug panel in editor", m_showIKDebug);
